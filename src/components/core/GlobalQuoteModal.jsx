...
export default function GlobalQuoteModal() {
  ...
  useEffect(() => {
    ...
    // Intercept clicks on links with href="#quote"
    const handleGlobalClick = (e) => {
      const target = e.target.closest('a[href="#quote"]');
      if (target) {
        e.preventDefault();
        setIsOpen(true);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        companyName: "N/A - Global Quote Form",
  ...
  const modalContent = (
    <div className="popup-cta-overlay" onClick={toggleModal} style={{ zIndex: 99999 }}>
      <div
